...
async function initNav(){
    ...
    whitelist.forEach((item) => {
        ...
        DomItem.innerHTML = `<a class="nav-link inline" onclick="changeReport('${item.name}')"><div class="circle tooltip"><div class="tooltiptext">${displayedCompliance}%</div></div> ${item.name}</a>`
